...
global cascade, resnet50, data
cascade = cv2.CascadeClassifier("/Users/rafid/OneDrive/Desktop/VSCode/Python/FeelBeat/FeelBeat/FB_Web/FeelBeat/fer/utilities/haarcascade_frontalface_default.xml")
resnet50 = keras.models.load_model('/Users/rafid/OneDrive/Desktop/VSCode/Python/FeelBeat/FeelBeat/FB_Web/FeelBeat/fer/utilities/SOA-EPOCHS_150-DROPOUT_0.3-test_acc_0.659.h5', compile=False)
label_map = ['angry', 'disgust', 'fear', 'happy', 'sad', 'surprise', 'neutral']
...
def content_based_recommendations(mood, songs_df, features, num_recommendations=10, top_n=100):
    ...
    if mood in moods_map:
        ...
        # Check if mood_profile contains NaN values and handle them
        if np.isnan(mood_profile).any():
            print("Warning: Mood profile contains NaN values. Adjusting to avoid errors.")
            mood_profile = np.nan_to_num(mood_profile)  # Replace NaN with 0 or other suitable values
...
def hybrid_recommendation(mood,predictions,data, songs_df,num_recommendations=10, top_n=100):
    ...
    context = pd.read_csv('/Users/rafid/OneDrive/Desktop/VSCode/Python/FeelBeat/FeelBeat/FB_Web/FeelBeat/fer/utilities/retrained_rf_model.pkl')
...
def hybrid_helper(activity,mood,predictions):
    ...
    songs_df = pd.read_csv('/Users/rafid/OneDrive/Desktop/VSCode/Python/FeelBeat/FeelBeat/FB_Web/FeelBeat/fer/utilities/data_moods.csv')
